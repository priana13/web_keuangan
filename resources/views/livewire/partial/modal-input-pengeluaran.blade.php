  ...
  <div id="modal-input-pengeluaran"  tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-lg max-h-full">
        ...
        <!-- Modal content -->
        <form wire:submit.prevent="save" wire:ignore.self method="post" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <input wire:model="tanggal" type="date" name="tanggal" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com">
                        <div>@error('tanggal') {{ $message }} @enderror</div>
                    </div>
                    
                    <div>
                        <label for="keterangan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Transaksi</label>
                        <input wire:model="keterangan" type="text" name="keterangan" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Nama Transaksi">

                        <div>@error('keterangan') {{ $message }} @enderror</div>
                    ...
                    <div>
                        ...
                        <div>@error('kategori_id') {{ $message }} @enderror</div>
                    </div>
                    ...
                    <div>
                        ...
                        <input wire:model="nominal" type="number" name="total" id="total" placeholder="Total" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                    </div>
                   
                    <button type="submit" class="rounded-lg bg-black py-2 px-5 text-center font-medium text-white hover:bg-opacity-90 lg:px-5">Simpan</button>
