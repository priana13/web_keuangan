...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mt-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
      <!-- ====== Chart One Start -->
      <div
          class="rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
          <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
            <div class="flex w-full flex-wrap gap-3 sm:gap-5">
                <div class="flex min-w-47.5">
                  ...
                  <div class="w-full">
                      <p class="font-semibold text-primary">Pemasukan</p>
                ...
                <div class="flex min-w-47.5">
                  ...
                  <div class="w-full">
                      <p class="font-semibold text-secondary">Pengeluaran</p>
                      {{-- <p class="text-sm font-medium">12.04.2022 - 12.05.2022</p> --}}
                  </div>
                </div>
            </div>
